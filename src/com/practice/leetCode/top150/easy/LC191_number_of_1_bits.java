 ...
 * representation is the same, whether it is signed or
 * unsigned.

 * In Java, the compiler represents the signed integers using
 * 2's complement notation. Therefore, in Example 3, the input
 ...
 * Output: 31
 * Explanation: The input binary string
 * 11111111111111111111111111111101 has a total of thirty one
 * '1' bits.

 * Constraints:
 * The input must be a binary string of length 32.

 * Follow up: If this function is called many times, how would
 * you optimize it?
 */
